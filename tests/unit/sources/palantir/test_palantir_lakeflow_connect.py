...
def test_palantir_connector():
    """Test the Palantir connector using the shared LakeflowConnect test suite."""
    # Inject the Palantir LakeflowConnect class into the shared test_suite namespace
    # so that LakeflowConnectTester can instantiate it.
    test_suite.LakeflowConnect = PalantirLakeflowConnect
