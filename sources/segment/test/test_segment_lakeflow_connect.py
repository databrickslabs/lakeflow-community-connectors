...
from sources.segment.segment import LakeflowConnect


def test_segment_connector():
    """Test the Segment connector using the shared LakeflowConnect test suite."""
    # Inject the Segment LakeflowConnect class into the shared test_suite namespace
    # so that LakeflowConnectTester can instantiate it.
    test_suite.LakeflowConnect = LakeflowConnect

    # Load connection-level configuration (e.g. api_token, region)
