...
def register_lakeflow_source(spark):
    ...
    class LakeflowSource(DataSource):
        ...
        @classmethod
        def name(cls):
            # Use "lakeflow_connect" for DLT/Lakeflow Connect pipeline compatibility
    ...
    # Also register as "arcgis" for direct PySpark testing convenience
    class ArcGISSource(LakeflowSource):
        @classmethod
        def name(cls):
            return "arcgis"


    # Register both format names
    spark.dataSource.register(LakeflowSource)  # "lakeflow_connect" for DLT pipelines
    spark.dataSource.register(ArcGISSource)    # "arcgis" for direct testing
