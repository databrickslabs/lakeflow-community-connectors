    ...
    def _create_survey_response(self, survey_id: str, response_data: Dict) -> bool:
        ...
        try:
            ...
            if session_response.status_code not in [200, 201]:
                ...
                if "incompatible" in error_detail.lower() or "unsupported question type" in error_detail.lower():
                    print("\n" + "=" * 70)
                    print("⚠️  SURVEY INCOMPATIBILITY DETECTED")
                    print("=" * 70)
                    print("The survey contains question types not supported by Sessions API.")
                    print("Sessions API only supports basic question types (text, multiple choice).")
