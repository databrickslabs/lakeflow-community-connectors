...
| **Homepage URL** | Your Databricks workspace URL<br/>Example: `https://e2-dogfood.staging.cloud.databricks.com/` |
| **Authorized Redirect URIs** | `https://<your-databricks-workspace>/login/oauth/zoho_crm.html`<br/>Example: `https://e2-dogfood.staging.cloud.databricks.com/login/oauth/zoho_crm.html` |
...
```
https://accounts.zoho.eu/oauth/v2/auth?response_type=code&client_id=1000.Q34QZ9YCNOAZWIZ8NXGRMMIU5BYGWE&scope=ZohoCRM.modules.ALL,ZohoCRM.settings.ALL,ZohoCRM.settings.modules.ALL&redirect_uri=https%3A%2F%2Fe2-dogfood.staging.cloud.databricks.com%2Flogin%2Foauth%2Fzoho_crm.html&access_type=offline&prompt=consent
```
...
```
https://e2-dogfood.staging.cloud.databricks.com/login/oauth/zoho_crm.html?code=1000.abc123...&location=eu&accounts-server=https://accounts.zoho.eu
```
...
curl -X POST "https://accounts.zoho.eu/oauth/v2/token" \
  -d "grant_type=authorization_code" \
  -d "client_id=1000.Q34QZ9YCNOAZWIZ8NXGRMMIU5BYGWE" \
  -d "client_secret=74996a2f6687a2f382d5fede7f66c3748ea43334c9" \
  -d "redirect_uri=https://e2-dogfood.staging.cloud.databricks.com/login/oauth/zoho_crm.html" \
...
```json
{
  "client_id": "1000.Q34QZ9YCNOAZWIZ8NXGRMMIU5BYGWE",
  "client_secret": "74996a2f6687a2f382d5fede7f66c3748ea43334c9",
  "refresh_token": "1000.YOUR_REFRESH_TOKEN_HERE",
  "redirect_uri": "https://e2-dogfood.staging.cloud.databricks.com/login/oauth/zoho_crm.html",
