...
from sources.spotify.spotify import LakeflowConnect


def test_spotify_connector():
    """Test the Spotify connector using the shared LakeflowConnect test suite."""
    # Inject the Spotify LakeflowConnect class into the shared test_suite namespace
    # so that LakeflowConnectTester can instantiate it.
    test_suite.LakeflowConnect = LakeflowConnect

    # Load connection-level configuration (e.g. client_id, client_secret, refresh_token)
