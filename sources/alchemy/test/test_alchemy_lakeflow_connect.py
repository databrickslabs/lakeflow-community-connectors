...
def test_alchemy_connector_core():
    ...
    assert connector.api_key, "api_key must be loaded from config"
...
def test_nft_metadata_batch():
    ...
    with mock.patch("requests.post", side_effect=mock_post):
        table_options = {
            "tokens": "0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D:1,0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D:2"
        }
