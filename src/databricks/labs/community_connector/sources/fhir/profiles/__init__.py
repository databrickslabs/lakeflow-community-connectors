...
_SCHEMA_REGISTRY: dict[tuple[str, str], StructType] = {}
_EXTRACTOR_REGISTRY: dict[tuple[str, str], Callable[[dict], dict]] = {}

# Profiles tried in order. First match wins.
# To add au_core: insert "au_core" before "uk_core"
PROFILE_CHAIN: list[str] = ["uk_core", "base_r4"]

_COMMON_FIELDS: list[StructField] = [
...
def _chain(from_profile: str) -> list[str]:
